...
<p>
<label>Password<br />
<input id="user_email" class="input" type="password" tabindex="20" size="25" value="<?php echo $_POST['password']; ?>" name="password"/>
</label>
</p>

<p>
<label>Company<br />
<input id="user_email" class="input" type="text" tabindex="20" size="25" value="<?php echo $_POST['company']; ?>" name="company"/>
</label>
</p>

<p>
<label>Age<br />
<input id="user_email" class="input" type="text" tabindex="20" size="25" value="<?php echo $_POST['age']; ?>" name="age"/>
</label>
</p>
...
// Enters into DB
wp_update_user( array ('ID' => $user_id, 'user_pass' => $password, 'first_name' => $first, 'last_name' => $last) ) ;

update_usermeta($user_id, 'company',$company);
update_usermeta($user_id, 'age',$age);
